...
app.get("/api/designs/:id/images", (req, res) => {
  ...
  res.set("Cache-Control", `public, max-age=${ONE_MINUTE}`);
  // Bilder ohne Wasserzeichen sind die tatsächliche Verkaufsdatei, die Kunden
  // nach dem Kauf erhalten (egal ob normale oder Hintergrund-Variante) - die
  // dürfen unabhängig vom sichtbar-Flag NIEMALS über die öffentliche Seite
